...
def get_config():
    ...
    model.feature_mask_path = os.path.join(data.root_dir, 'data/global_mask_res64_occaug_normalized_v1.pt')
    model.pixcat_mask_path = os.path.join(data.root_dir, 'data/cat_mask_res64_occaug_normalized_v1.pt')
